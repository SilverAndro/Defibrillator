...
object TexturingConstants {
    ...
    val OUT_ID = listOf(894754875, -1741863695, -1947963016, 1537745656)

    const val PLUS_TEXTURE =
    ...
    val PLUS_ID = listOf(-2043523718, -777107838, -1082670654, 1929131299)

    const val NEXT_TEXTURE =
    ...
    val NEXT_ID = listOf(-1924610023, 724324220, -1668086297, 1774964076)

    const val BACK_TEXTURE =
    ...
    val BACK_ID = listOf(-1851153710, -1126085201, -2100427987, 895449682)

    const val INFO_TEXTURE =
    ...
    val INFO_ID = listOf(-1255748294, -2041099761, -1825112504, 2136088914)

    const val HASH_TEXTURE =
    ...
    val HASH_ID = listOf(-1704412717, -1610265263, -1967963385, 273102471)
}
